   ...
   <header>
    <div className="flex py-5 px-3">
      ...
      <div className="flex items-center">
        <a href="#">
          <img src="images/icon-menu.svg" alt="menu icon" className="block lg:hidden" />
        </a>
        <div className="hidden lg:flex lg:space-x-10 lg:items-center">
          <div className="hover:text-almost-black cursor-pointer">login</div>
          <div>
              <div><button className="border-2 hover:border-almost-black hover:text:almost-black rounded-xl px-4 py-2">Register</button></div>
          </div>
        </div>
      </div>
    </div>
